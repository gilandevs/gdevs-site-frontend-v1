document.addEventListener("DOMContentLoaded", function () {
  (function () {
    var button = document.querySelector(".download-images");
    ...
    button.addEventListener("click", function (e) {
      e.preventDefault();
      window.open("/storage/img/instagram/Instagram-story-1.png");
      window.open("/storage/img/instagram/Instagram-story-2.png");
      window.open("/storage/img/instagram/Instagram-story-3.png");
    });
  })();
  (function () {
